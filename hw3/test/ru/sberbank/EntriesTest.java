...
class EntriesTest {
    ...
    void addEntry() {
        ...
        Transaction transaction2 = transactionManager.createTransaction(100, debitCard2, debitCard1);
        Entry entry1 = new Entry(debitCard1, transaction1, 100, LocalDateTime.now());
        Entry entry2 = new Entry(debitCard2, transaction2, 100, LocalDateTime.now());
